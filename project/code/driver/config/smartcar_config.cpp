...
bool load_from_path(const std::string &path, std::string *error_message)
{
    ...
    if (!require_int(values, &consumed, "vision.runtime.send_mode", &g_vision_runtime_config.send_mode, error_message) ||
        ...
        !require_float(values, &consumed, "vision.runtime.red_roi.red_to_target_bottom_x1", &g_vision_runtime_config.red_roi_red_to_target_bottom_x1, error_message) ||
        !require_float(values, &consumed, "vision.runtime.red_roi.red_to_target_bottom_y1", &g_vision_runtime_config.red_roi_red_to_target_bottom_y1, error_message) ||
    ...
    if (g_vision_runtime_config.red_roi_square_side_px <= 0 ||
        std::fabs(g_vision_runtime_config.red_roi_red_to_target_bottom_x2 -
                  g_vision_runtime_config.red_roi_red_to_target_bottom_x1) < 1.0e-6f)
    {
        *error_message = "vision.runtime.red_roi contains invalid value";
        return false;
    }
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.red_to_target_bottom_k");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.red_to_target_bottom_b");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.h_span");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.s_min");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.v_min");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.close_iter");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.open_iter");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.area_min");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.ratio_w");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.ratio_h");
    consume_optional_key_if_present(values, &consumed, "vision.runtime.red_roi.offset_ratio");
