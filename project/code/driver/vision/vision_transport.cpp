...
static void send_tcp_status()
{
    ...
    if (!send_full_debug)
    {
        ...
        append_string(true, "board_fail_reason", has_infer_result ? infer_result.board_fail_reason : "no_result");
        ...
        append_int_array(true, "board_corner_bl", {infer_result.board_corner_bl_x, infer_result.board_corner_bl_y});
        append_int_array(true, "board_corner_br", {infer_result.board_corner_br_x, infer_result.board_corner_br_y});
        append_int_array(true, "board_corner_tr", {infer_result.board_corner_tr_x, infer_result.board_corner_tr_y});
        append_int_array(true, "board_corner_tl", {infer_result.board_corner_tl_x, infer_result.board_corner_tl_y});
        append_int_array(true, "board_ipm_red_bottom", {infer_result.board_ipm_red_bottom_x, infer_result.board_ipm_red_bottom_y});
        append_int_array(true, "board_ipm_bottom", {infer_result.board_ipm_bottom_x, infer_result.board_ipm_bottom_y});
        append_int_array(true, "board_ipm_top", {infer_result.board_ipm_top_x, infer_result.board_ipm_top_y});
        append_int_array(true, "board_ipm_bl", {infer_result.board_ipm_bl_x, infer_result.board_ipm_bl_y});
        append_int_array(true, "board_ipm_br", {infer_result.board_ipm_br_x, infer_result.board_ipm_br_y});
        append_int_array(true, "board_ipm_tr", {infer_result.board_ipm_tr_x, infer_result.board_ipm_tr_y});
        append_int_array(true, "board_ipm_tl", {infer_result.board_ipm_tl_x, infer_result.board_ipm_tl_y});
        append_int_array(true, "board_src_bl", {infer_result.board_src_bl_x, infer_result.board_src_bl_y});
        append_int_array(true, "board_src_br", {infer_result.board_src_br_x, infer_result.board_src_br_y});
    ...
    {
        bool left_roi_valid = false;
        const uint8 *left_roi_data = nullptr;
        int left_roi_cx = -1, left_roi_cy = -1;
        vision_image_processor_get_cross_history_roi_7x7(true, &left_roi_valid, &left_roi_data, &left_roi_cx, &left_roi_cy);
        append_u8_array(left_roi_valid, "cross_left_history_roi_7x7", left_roi_data, 49);
        append_int_array(left_roi_valid, "cross_left_history_roi_corner", {left_roi_cx, left_roi_cy});
        int left_upper_source = -1;
        vision_image_processor_get_cross_upper_corner_source(true, &left_upper_source);
        append_int(true, "cross_left_upper_corner_source", left_upper_source);

        bool right_roi_valid = false;
        const uint8 *right_roi_data = nullptr;
        int right_roi_cx = -1, right_roi_cy = -1;
        vision_image_processor_get_cross_history_roi_7x7(false, &right_roi_valid, &right_roi_data, &right_roi_cx, &right_roi_cy);
        append_u8_array(right_roi_valid, "cross_right_history_roi_7x7", right_roi_data, 49);
        append_int_array(right_roi_valid, "cross_right_history_roi_corner", {right_roi_cx, right_roi_cy});
        int right_upper_source = -1;
        vision_image_processor_get_cross_upper_corner_source(false, &right_upper_source);
        append_int(true, "cross_right_upper_corner_source", right_upper_source);
    }
