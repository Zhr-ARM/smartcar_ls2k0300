...
vision_runtime_config_t g_vision_runtime_config = {
    ...
    .ipm_line_error_point_indices = {6, 12, 17},
    // line_error 各索引点对应权重。
    .ipm_line_error_weights = {0.6f, 0.3f, 0.1f},
...
vision_processor_config_t g_vision_processor_config = {
    ...
    // 逆透视矩阵（标定参数）。
    .change_un_mat = {
        {0.636458, -0.438969, -11.985072},
        {-0.000000, 0.095313, -0.063178},
        {-0.000000, -0.005772, 1.003826}
    },
    // 相机内参矩阵（标定参数）。
    .camera_matrix = {
