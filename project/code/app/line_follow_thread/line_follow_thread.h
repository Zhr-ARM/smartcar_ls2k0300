...
struct LineFollowPidDebugStatus
{
    ...
    float error_slowdown_start_px;
    float error_slowdown_full_px;
    bool error_slowdown_ready;
    bool error_slowdown_triggered;
    float preview_slowdown_start_dps;
    float preview_slowdown_full_dps;
    bool preview_slowdown_ready;
    bool preview_slowdown_triggered;
    ...
    bool front_preview_slowdown_ready;
    bool front_preview_slowdown_triggered;
    int speed_slowdown_winner_branch;
