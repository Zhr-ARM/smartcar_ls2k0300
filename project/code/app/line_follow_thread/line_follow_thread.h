...
struct LineFollowPidDebugStatus
{
    ...
    bool steering_feedforward_preview_valid;
    int steering_feedforward_preview_x;
    int steering_feedforward_preview_y;
    float steering_feedforward_preview_angle_deg;
    float steering_feedforward_filtered_preview_angle_deg;
    ...
    float steering_feedforward_centerline_confidence;
    float steering_feedforward_feedback_room_limit;
    float steering_feedforward_raw_output;
    float steering_feedforward_base_limited_output;
    float steering_feedforward_output;
    float yaw_pid_kp;
    float yaw_pid_ki;
    float yaw_pid_kd;
    ...
    float speed_scheme_realtime_speed;
    float speed_scheme_friction_coupling;
